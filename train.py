...
class StreetlightMLPipeline:
    ...
    def fetch_data(self):
        """Fetch all status data from MongoDB"""
    ...
    def engineer_features(self, df):
        """Create features for ML models including weather"""
    ...
    def detect_anomalies(self, df):
        ...
        features = [
            'power_w', 'dim', 'power_rolling_mean', 'power_rolling_std',
    ...
    def predictive_maintenance(self, df):
        ...
        feature_cols = [
            'power_w', 'dim', 'hour', 'day_of_week', 'is_night',
    ...
    def predict_state(self, df):
        """Predict streetlight state"""
        print("\n=== STATE PREDICTION ===")
        
        feature_cols = [
            'hour', 'day_of_week', 'power_rolling_mean', 
            'power_rolling_std', 'dim',
            'precipitation', 'weather_encoded', 'temperature'
        ]
